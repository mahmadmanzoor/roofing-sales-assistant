...
export default function Home() {
  ...
  const [messages, setMessages] = useState(['WhatsApp demo ready. Ask for the latest leads near your service area.'])
  ...
  return <main className={styles.shell}>
    <section className={styles.hero}><div><p className={styles.eyebrow}>ROOFING SALES ASSISTANT · DEMO MODE</p><h1>From permit lead to proposal, inside WhatsApp.</h1><p className={styles.subhead}>A realistic contractor workflow with Meta-ready webhooks, deterministic pricing, and safe simulated email.</p></div><div className={styles.badge}>● Demo simulator active</div></section>
